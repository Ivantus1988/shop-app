package com.shukalovich.database.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.shukalovich.database.repository")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Properties hibernateProperties) {
        ...
        entityManagerFactory.setPackagesToScan("com.shukalovich.database.entity");
